...
1. In the latest release's _Downloads_ section, download the ZIP archive of the deck, "Chess.rar". you can also install one of the premade shared decks within the "Shared.Decks.rar" zip.
